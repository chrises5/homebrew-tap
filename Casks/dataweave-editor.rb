cask "dataweave-editor" do
  ...
  on_arm do
    ...
    url "https://github.com/chrises5/dataweave-editor/releases/download/v#{version}/DataWeave%20Editor-#{version}-arm64-mac.zip"
  end

  on_intel do
    sha256 "eccc87412b7197dc905c599e2c59352ed6209c2a1ccda553004b35fd07a41db9"
    url "https://github.com/chrises5/dataweave-editor/releases/download/v#{version}/DataWeave%20Editor-#{version}-x64-mac.zip"
  end
